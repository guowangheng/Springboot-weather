...
public class ConfigurationContext {
    ...
    @Bean(name = "jobDetail")
    public MethodInvokingJobDetailFactoryBean detailFactoryBean(WeatherFlushJob task) {
        ...
        jobDetail.setName("scheduler_weather");// 设置任务的名字
    ...
    public CronTriggerFactoryBean cronJobTrigger(MethodInvokingJobDetailFactoryBean jobDetail) {
        ...
        tigger.setCronExpression("0 0/30 * * * ?");// 表示每隔6秒钟执行一次
        //tigger.set
